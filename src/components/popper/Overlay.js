...
const Overlay = (props) => {
  ...
  useEffect(() => {
    ...
    if (!show) {
      ...
      setTimeout(() => {
        if (container.querySelectorAll('.hi-theme-popper__container').length === 0) {
  ...
  return (
    <div
      ...
      className={classNames(overlayClassName, 'hi-theme-popper__container', {
        'hi-theme-popper__container--hide': !show
      })}
    ...
    >
      <div
        ...
        className={classNames(className, 'hi-theme-popper__content', `hi-theme-popper__content--${offset.placement}`, {
          'hi-theme-popper__content--hide': popperHeight === 0 || popperWidth === 0
        })}
        style={{ width, height }}
