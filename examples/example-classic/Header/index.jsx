...
export default class NavHeader extends Component {
  constructor () {
    ...
    this.state = {
      colors: [
        { value: 'white', title: '浅色' },
        { title: '深色', value: 'black' },
        { title: '蓝色', value: 'blue' }
      ],
      color: 'black',
      layouts: [
      ...
      <React.Fragment>
        <NavGroup position='left'>
          <NavGroup.Item>
            <span
              className={`${
                ['black', 'blue'].includes(this.state.color) ? 'custome-dropdown' : ''
              }`}
            >
              <Dropdown
        ...
        <NavGroup position='center'>
          <NavGroup.Item>
            <NavLink to='/' exact activeClassName='header__nav-link--active'>
              首页
            </NavLink>
          </NavGroup.Item>
          <NavGroup.Item>
            <NavLink to='/products/mix3' activeClassName='header__nav-link--active'>
              产品系列
            </NavLink>
          </NavGroup.Item>
          <NavGroup.Item>
            <NavLink to='/statistics/phone' activeClassName='header__nav-link--active'>
              统计数据
            </NavLink>
          </NavGroup.Item>
          <NavGroup.Item>
            <NavLink to='/about' activeClassName='header__nav-link--active'>
              其它
            </NavLink>
          </NavGroup.Item>
        </NavGroup>
